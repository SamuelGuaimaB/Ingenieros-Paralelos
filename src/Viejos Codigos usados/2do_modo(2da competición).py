...
RUTINA_MANUAL = [
    ...
    (-140, 86,  0.2,  "Retroceso estacionamiento"),
    (0,   60,  0.5,  "Pausa medicion"),
    (140, 60,  0.23,  "Giro Hacia afuera Corto(Derecha)"),
    (0,   120,  0.5,  "Pausa medicion"),
    (-140, 120,  0.21,  "Retroceso Acomodo(Derecha)"),
    (0,   60,  0.5,  "Pausa medicion"),
    (140, 60,  0.23,  "Giro Hacia afuera Corto(Derecha)"),
    (0,   120,  0.5,  "Pausa medicion"),
    (-140, 120,  0.21,  "Retroceso Acomodo(Derecha)"),
    ...
    (-140, 120,  0.21,  "Retroceso Acomodo(Derecha)"),
    (0,   60,  0.5,  "Pausa medicion"),
    (250, 86,  2.65,  "1. Initial straight acceleration (test)"),
    # First lap
    (140, 60,  1.5,  "Endereso a recta(Derecha)"),
    (250, 86,  1.1,  "1-2 obstac"),
    (250, 120,  0.5,  "c"),
    (250, 86,  0.5,  "d"),
    (250, 86,  2,  "1-2 obstac"),
    (180, 60,  1.9, "3-4"),
    (250, 86,  6.3,  "4-5"),
    (180, 120,  0.8,  "5-6"),
    #(250, 86,  2.8,  "Recta media"),
    #(180, 120,  1.4,  "5"),
    #(250, 86,  3.2,  "3. Recta media"),
    #(180, 120,  1.1,  "6-inic"),
    #(250, 86,  2.2,  "3. Recta final"),
    # Second lap
    
    
    #(180, 120,  2.1, "obstaculo 1"),
    #(250, 86,  1.8,  "entre osbtac 1 - 2"),
    #(250, 86,  2,  "Recta media"),
    #(180, 120,  1.6,  "3-4"),
    #(250, 86,  1.6,  "3. Recta media"),
    #(180, 120,  0.9,  "2. Toma de la Curva 3 (Derecha)"),
    #(250, 86,  2.1,  "3. Recta media"),
    #(180, 120,  1.95,  "2. Toma de la Curva 4 (Derecha)"),
    #(250, 86,  2.2,  "3. Recta final"),
